    ...
    <section className=''>
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between'>
          ...
          <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Hi, <br />Nama ku <br/>Dana Putra</h1>
          <p className='md:text-2xl text-xl mb-4'>Not pro gamer, Illustrator</p>
