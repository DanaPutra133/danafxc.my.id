...
const Artwork = () => {
    return (
        <div id='Artwork' className='border min-h-screen flex flex-col lg:flex-row justify-center items-center lg:px-32 px-5'>
            <img src={img} alt="img" className='lg:w-10/12'/>
            <div className='space-y-4 lg:pt-14 ml-6 text-sm'>
                <h1 className='font-semibold text-4xl text-center md:text-start'>Artwork Us</h1>
