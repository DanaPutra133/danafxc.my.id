...
const Contact = () => {
    return (
        <section id='contact' className='z-50 bg-gray-300 relative py-10'>
            <div className='mb-16 max-w-7xl mx-auto'>
                <div className='flex flex-col md:flex-row justify-between items-center'>
                    ...
                    <form className='w-full md:w-1/2 bg-gray-100 rounded-lg border border-pink-300 shadow-lg shadow-pink-500 p-10'>
                        <h1 className='text-4xl font-bold mb-7'>Contact Me</h1>
                        <div className='mb-4'>
                            <label htmlFor="name" className='block text-sm font-medium text-black/80'>Name</label>
                        ...
                        <div className='mb-4'>
                            <label htmlFor="email" className='block text-sm font-medium text-black/80'>Email</label>
                            <input type="text" id="name" placeholder='Email' className='mt-1 p-2 block w-full rounded-md 
                            border-gray-400 shadow-sm focus:border-indigo-300 focus:ring
                            focus:ring-indigo-200 focus:ring-opacity-50'/>
                        </div>
                        <div className='mb-4'>
                            <label htmlFor="message" className='block text-sm font-medium text-black/80'>Message</label>
                            <textarea id="message" placeholder='Enter Your Message' className='mt-1 p-2 block w-full rounded-md 
                            border-gray-400 shadow-sm focus:border-indigo-300 focus:ring
                            focus:ring-indigo-200 focus:ring-opacity-50'/>
                        </div>
                        <button className='bg-pink-600 px-3 py-2 rounded-lg'>Send Message</button>
                    </form>
                </div>
            </div>
        </section>
